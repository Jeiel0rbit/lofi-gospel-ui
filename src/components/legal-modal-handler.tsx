...
const legalContent = {
  terms: {
    ...
    content: (
      <>
        ...
        <p className="mb-4">O LoFi Gospel Hub é fornecido para seu uso pessoal e não comercial. O bot está de acordo com os Termos de Serviço para Bots do Discord. Você concorda em não usar o bot para fins ilegais.</p>
  ...
  privacy: {
    ...
    content: (
      <>
        <p className="mb-4">Sua privacidade é importante para nós. Esta Política de Privacidade explica como coletamos, usamos e protegemos as informações necessárias para o funcionamento do LoFi Gospel Hub.</p>
        ...
        <p className="mb-4">Os dados coletados são usados exclusivamente para a operação, manutenção e melhoria do LoFi Gospel Hub. Não há vendas de dados ou monitoramento dos usuários para outros fins não éticos. Não coletamos nenhuma informação de identificação pessoal (PII).</p>
